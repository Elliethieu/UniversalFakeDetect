...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--real_path', type=str, default=None, help='paths to folders containing fake images')
        parser.add_argument('--fake_paths', type=str, nargs='+', default=None, help='List of paths to folders containing fake images')
