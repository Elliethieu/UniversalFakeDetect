...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--Dalle_path', type=str, default=None, help='paths to folders containing others images')
        parser.add_argument('--others_paths', type=str, nargs='+', default=None, help='List of paths to folders containing others images')
        ...
        # 
        #parser.add_argument('--Dalle_list_path', default=None, help='only used if data_mode==ours: path for the list of Dalle images, which should contain train.pickle and val.pickle')
        #parser.add_argument('--others_list_path', default=None, help='only used if data_mode==ours: path for the list of others images, which should contain train.pickle and val.pickle')
